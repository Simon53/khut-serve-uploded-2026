...
document.addEventListener("DOMContentLoaded", () => {
    ...
    function validateQuantity() {
        ...
        const stock = parseInt(stockDisplay.innerText) || 0;
    ...
    function fetchStock(barcode) {
        ...
        fetch(stockUrl)
            ...
            .then(res => {
                ...
                const inCatalog =
                    res?.success &&
                    data.in_catalog === true;


                const qty =
                    inCatalog
                        ? (Number(data.store_stock) || 0)
                        : 0;
    ...
    function validateInputs() {
        ...
        const hasColors =
            colorContainer &&
            colorContainer.querySelectorAll(".colorBtn").length > 0;


        const hasSizes =
            sizeContainer &&
            sizeContainer.querySelectorAll(".sizeBtn").length > 0;
    ...
    colorContainer?.querySelectorAll(".colorBtn").forEach(btn => {
        ...
        btn.addEventListener("click", () => {
            ...
            if (sizes.length === 0) {
                ...
                // Reset quantity while selecting size
                if (quantityInput) {
            ...
            sizes.forEach(opt => {
                ...
                sizeBtn.className =
                    "sizeBtn btn btn-outline-secondary m-1";


                sizeBtn.dataset.barcode =
                    opt.barcode;
    ...
    const firstColorBtn =
        colorContainer?.querySelector(".colorBtn");
    ...
    addToCartBtn?.addEventListener(
        ...
        (e) => {
            ...
            // Current stock
            const stock =
                parseInt(stockDisplay.innerText) || 0;
            ...
            const productData = {
                ...
                tax_status:
                    addToCartBtn.dataset.taxStatus ||
                    'Standard'
            ...
            if (existing) {
                ...
                if (totalQty > stock) {
                    ...
                    showCartToast(
                        `Only ${stock} item(s) available. You already have ${existingQty} in cart.`
                    );
            ...
            if (
                typeof updateCartCounts === "function"
            ) {
    ...
    function showCartToast(message) {
        ...
        if (!toastEl) {
            ...
            toastEl.style.padding =
                "10px 20px";


            toastEl.style.borderRadius =
                "5px";
        ...
        if (window.innerWidth <= 768) {
            ...
            function setTransform() {
                ...
                img.css({
                    ...
                    "transform":
                        `scale(${ZOOM}) translate(${moveX}px, ${moveY}px)`,
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const btn =
        document.getElementById("openZoom");
