      ...
      @if($featureProduct)
         ...
         <div class="container topGap-1">
            <div class="row">
               {{-- ===== Left Side ===== --}}
               <div class="col-lg-5">
                  <div class="link-titel" style="display:none!important"> 
                  ...
                  <h3 class="price" style="text-align: left!important;">BDT {{ number_format($featureProduct->price, 0) }}</h3>

                  <p class="mt-5 details-text">
                     {!! $featureProduct->details !!}
                  </p>

                  <p class="mt-5 custom-link custom-mobile-btn">
                     
                     @if($featureProduct->child_menu_id)
                        <a href="{{ url('/childcategory/' . $featureProduct->child_menu_id) }}">
                           See More Products
                        </a>

                     @elseif($featureProduct->sub_menu_id)
                        <a href="{{ url('/subcategory/' . $featureProduct->sub_menu_id) }}">
                           See More Products
                        </a>

                     @elseif($featureProduct->main_menu_id)
                        <a href="{{ url('/category/' . $featureProduct->main_menu_id) }}">
                           See More Products
                        </a>
               ...
               <div class="col-lg-7 right-content">
                  <a href="{{ route('product.details', $featureProduct->slug) }}">
                     ...
                     <p class="mt-3 custom-link text-center btnposition-desctop-home-1">
         ...
         <div class="container topGap-2">
            <div class="row">
                  <div class="col-lg-5">
                     ...
                     <h3 class="price" style="text-align: left!important;">BDT {{ number_format($featureTwoProduct->price, 0) }}</h3>
                     ...
                     <p class="mt-5 custom-link custom-mobile-btn">
                        ...
                        @if($featureTwoProduct->child_menu_id)
                              <a href="{{ url('/childcategory/' . $featureTwoProduct->child_menu_id) }}">
                                 See More Products
                              </a>

                           @elseif($featureTwoProduct->sub_menu_id)
                              <a href="{{ url('/subcategory/' . $featureTwoProduct->sub_menu_id) }}">
                                 See More Products
                              </a>

                           @elseif($featureTwoProduct->main_menu_id)
                              <a href="{{ url('/category/' . $featureTwoProduct->main_menu_id) }}">
                                 See More Products
                              </a>
                  ...
                  <div class="col-lg-7 right-content">
                     ...
                     <p class="mt-3 custom-link text-center btnposition-desctop-home-2">
   ...
   <div class="row align-items-center justify-content-center">
      ...
      <div class="fastive-text text-center fastive-text-div col-lg-6 col-md-6">
            ...
            <p class="mt-4 custom-link">
               ...
               <a href="{{ route('all.products.list', 'festive-collection') }}">See All Festive Collection</a>
            </p>
      </div>
...
<!-- ===== Festive Section End ===== -->
      ...
      <div class="container topGap-2">
         <div class="row align-items-center">
            ...
            <div class="col-lg-7">
               ...
               Patchwork is a form of needlework in which small pieces of cloth with different designs, patterns, colors or textures are sewn together. Each piece of patchwork is uniquely different.
            </div>

            <!-- Right side: Link -->
            <div class="col-lg-5 d-flex justify-content-end custom-link Patchwork-btn">
        ...
        <!-- ===== Ho-jo-bo-ro-lo Section Start ===== -->
         <div class="container topGap-2">
            <div class="row mb-3 flex-wrap">
             ...
             <!-- Right side: Link -->
              <div class="col-lg-4 d-flex justify-content-end align-items-center custom-link Patchwork-btn">
      ...
      <hr class="devider-container" style="height: 2px !important; margin-top: -20px;">
       <!-- ===== section start ===== -->
