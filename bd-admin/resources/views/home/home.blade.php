...
<div class="container-fluid">
    ...
    <div class="row mb-4">
        ...
        <div class="col-md-3">
            <div class="card stat-card text-white p-3" style="background-color:#dc3545;">
                <h5>Cancelled Orders</h5>
                <h3 id="cancelOrder">{{ $cancelOrder }}</h3>
            </div>
        </div>
    </div>
    {{-- Charts --}}
...
<script>
    ...
    new Chart(document.getElementById('weeklyChart'), {
        type: 'bar',
        data: { labels: weeklyLabels, datasets: [{ label: 'Weekly Sale', data: weeklyData, backgroundColor: 'rgba(54, 162, 235, 0.6)', borderColor: 'rgba(54, 162, 235, 1)', borderWidth: 1 }]},
    ...
    new Chart(document.getElementById('monthlyChart'), {
        type: 'line',
        data: { labels: monthlyLabels, datasets: [{ label: 'Monthly Sale', data: monthlyData, fill: true, backgroundColor: 'rgba(75, 192, 192, 0.2)', borderColor: 'rgba(75, 192, 192, 1)', tension: 0.1 }]},
    ...
    new Chart(document.getElementById('yearlyChart'), {
        type: 'line',
        data: { labels: yearlyLabels, datasets: [{ label: 'Yearly Sale', data: yearlyData, fill: true, backgroundColor: 'rgba(255, 206, 86, 0.2)', borderColor: 'rgba(255, 206, 86, 1)', tension: 0.1 }]},
        options: { responsive: true }
    });
    ...
    function loadDashboardStats() {
        fetch('/dashboard/stats')
            ...
            .then(data => {
                ...
                document.getElementById('confirmedDelivery').innerText = data.confirmedDelivery;
                document.getElementById('cancelOrder').innerText = data.cancelOrder;
