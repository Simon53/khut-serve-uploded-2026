@extends('layout.app')
@section('title', 'Khut::Create Story')
@section('content')
<style>
...
<div class="container">
   <div class="page-header">
      <h3 class="page-title">Add New Khut Story</h3>
   </div>
</div>
<div class="container">
    <form action="{{ route('khut-stories.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="row">
            ...
            <div class="col-sm-12">
              <div class="form-check">
                  ...
                  <input type="checkbox" class="form-check-input" name="is_active" id="is_active" value="Y"> Show Home <i class="input-helper"></i></label>
              </div>
            </div>
